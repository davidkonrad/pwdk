...
<main role="main">
	<section class="jumbotron text-center">
		<div class="container">
			...
			<p>
				<a class="btn btn-primary my-2" href="om-pernille-weidner">Om Pernille Weidner</a>
				<a class="btn btn-secondary my-2" href="kontakt">Kontakt</a>
			</p>
		</div>
	</section>
	...
	<div class="py-5">
		<div class="container">
            ...
            <div class="col-md-4">
              <a class="card mb-4 box-shadow text-muted" href="klangmassage">
            ...
            <div class="col-md-4">
              <a class="card mb-4 box-shadow text-muted" href="kakao-ceremoni">
            ...
            <div class="col-md-4">
              <a class="card mb-4 box-shadow text-muted" href="lydhealing">

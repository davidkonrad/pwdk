		...
		<div class="container">
			<div class="row">
				<div class="col-sm-8 col-md-7 py-4">
					<img src="assets/pernille-weidner-mugshot-ii.jpg" class="rounded-circle img-thumbnail float-left w-25 mr-sm-3" style="object-fit:cover;">
					<p class="text-muted">
...
klangmassage behandler og klangaktør <a href="om-pernille-weidner" class="text-dark text-decoration-none" title="Læs mere om Pernille Weidner">læs mere ...</a></p>
				</div>
